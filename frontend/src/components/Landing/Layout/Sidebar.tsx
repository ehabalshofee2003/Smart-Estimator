...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-secondary-900 border-l border-white/10 p-6 flex flex-col justify-between fixed h-full right-0 top-0 z-40">
      ...
      <button className="w-full flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-500/10 rounded-xl transition duration-200 border border-transparent hover:border-red-500/20">
        <LogOut size={20} />
